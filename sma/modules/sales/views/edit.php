...
<?php if($message) { echo "<div class=\"alert alert-error\"><button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>" . $message . "</div>"; } ?>
	...
	<?php $attrib = array('class' => 'form-horizontal', 'id' => 'addSale_form'); echo form_open("module=sales&view=edit&id=".$id, $attrib); ?>
...
<div class="control-group">
  ...
  <div class="controls">  <?php 
	 $bl[""] = "";
		...
		echo form_dropdown('biller', $bl, (isset($_POST['biller']) ? $_POST['biller'] : $inv->biller_id), 'id="biller_s" data-placeholder="'.$this->lang->line("select").' '.$this->lang->line("biller").'" required="required" data-error="'.$this->lang->line("biller").' '.$this->lang->line("is_required").'"'); ?> </div>
</div>
<div class="control-group">
  ...
  <div class="controls">  <?php 
	 $cu[""] = "";
		...
		echo form_dropdown('customer', $cu, (isset($_POST['customer']) ? $_POST['customer'] : $inv->customer_id), 'id="customer_s" data-placeholder="'.$this->lang->line("select").' '.$this->lang->line("customer").'" required="required" data-error="'.$this->lang->line("customer").' '.$this->lang->line("is_required").'"'); ?> </div>
</div>
<?php if(TAX2) { ?>
<div class="control-group">
  ...
  <div class="controls">  <?php 
	  $tr[""] = "";
		...
		echo form_dropdown('tax2', $tr, (isset($_POST['tax2']) ? $_POST['tax2'] : $inv->tax_rate2_id), 'id="tax2_s" data-placeholder="'.$this->lang->line("select").' '.$this->lang->line("tax2").'" required="required" data-error="'.$this->lang->line("tax2").' '.$this->lang->line("is_required").'"'); ?> </div>
</div>
<?php } ?>
...
<div class="control-group">
  ...
  <div class="controls">  <?php 
	  $ds[""] = "";
		...
		echo form_dropdown('inv_discount', $ds, (isset($_POST['inv_discount']) ? $_POST['inv_discount'] : $inv->discount_id), 'id="discount_s" data-placeholder="'.$this->lang->line("select").' '.$this->lang->line("discount").'" required="required" data-error="'.$this->lang->line("discount").' '.$this->lang->line("is_required").'"'); ?> </div>
</div>
<?php } ?>
...
<table id="dyTable" class="table items table-striped table-bordered table-condensed table-hover">
  ...
  <?php $r = 1; foreach($inv_products as $prod){ 
			 ...
			 if(PRODUCT_SERIAL) { echo '<td><input class="span2 tran2" name="serial'. $r .'" id="serial'. $r .'" type="text" value="'.$prod->serial_no.'"></td>'; } 
