...
$(document).ready(function(){
	...
	$("#dyTable").on("click", '.del', function() {
		...
		$('#supplier_l').on('click', function(){ setTimeout(function(){ $('#supplier_s').trigger('liszt:open'); }, 0); });
...
<?php if($message) { echo "<div class=\"alert alert-error\"><button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>" . $message . "</div>"; } ?>
	...
	<?php $attrib = array('class' => 'form-horizontal', 'id' => 'addSale_form'); echo form_open("module=inventories&view=edit&id=".$id, $attrib); ?>
...
<div class="control-group">
  ...
  <div class="controls">  <?php 
	 $sp[""] = "";
		...
		echo form_dropdown('supplier', $sp, $inv->supplier_id, 'id="supplier_s" data-placeholder="'.$this->lang->line("select").' '.$this->lang->line("supplier").'" required="required" data-error="'.$this->lang->line("supplier").' '.$this->lang->line("is_required").'"'); ?> </div>
</div>
